...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb pl-3">
            <li class="breadcrumb-item active" aria-current="page">Payment / Withdraw and Deposits</li>
        </ol>
    </nav>
                        ...
                        <table class="table table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size:16px;font-weight:500">Payment Name</th>
                                    <th style="font-size:16px;font-weight:500">Amount</th>
                                    <th style="font-size:16px;font-weight:500">Transaction_number</th>
                                    <th style="font-size:16px;font-weight:500">Date</th>
                                    <th style="font-size:16px;font-weight:500">Type</th>
                            ...
                            <tbody>
                                @foreach ($data as $p)
                                    <tr>
                                        ...
                                        <td style="font-size:15px;font-weight:500">{{ $p->transaction_number ? $p->transaction_number : '-' }}</td>
                                        <td style="font-size:15px;font-weight:500">{{ $p->date? $p->date: '-' }}</td>
                                        <td style="font-size:15px;font-weight:500">{{ $p->type }}</td>
                                        <td style="font-size:15px;font-weight:500" class="">
                                            <div class="border  {{ $p->status === 'comfirm' ? 'border-success' : 'border-primary' }} rounded-2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item text-success"
                                                            href="{{ route('admin.payment.listdandw.filter', $p->id) }}"><i
