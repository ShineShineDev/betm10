                        ...
                        <table class="table table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size:16px;font-weight:500">Transaction_Date</th>
                            ...
                            <tbody>
                                @foreach ($deposit as $p)
                                    <tr>
                                        ...
                                        <td style="font-size:15px;font-weight:500">{{ $p->transaction_number }}</td>
                                        <td style="font-size:15px;font-weight:500">{{ $p->transaction_date }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item text-success"
                                                            href="{{ route('admin.payment.status', $p->id) }}"><i
