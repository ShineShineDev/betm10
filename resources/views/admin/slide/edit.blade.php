...
@section('content')
    ...
    <div class="modal fade" data-keyboard="false" data-backdrop="static" id="modal" tabindex="-1" role="dialog"
                    ...
                    <form action="{{route('admin.slide.update',$slide->id)}}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group form-group">
                                <input required type="file" id="input"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="sort" value="{{old('sort') ?? $slide->sort}}"
                                       class="form-control">
                            </div>
                        </div>
