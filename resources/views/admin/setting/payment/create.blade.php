            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                <div class="card-header">
                  <h1 class="card-title">Add Payment Method</h1>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="mr-1 input-group" style="flex-grow: 1">
                                    <input required id="image" name="image" type="file" class="form-control @error('image') is-invalid @enderror" placeholder="Enter image" value="{{old('image')}}">
                                    @error('image')
