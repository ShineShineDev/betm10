<!-- Add Section -->
<div class="modal fade" id="addBlockNumberToSection" tabindex="-1" role="dialog" aria-labelledby="addSection"
    aria-hidden="true">
    <form method="post" action="{{ route('admin.threed.section.block_number.store')}}">
        @csrf
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content py-2">
                <div class="modal-header p-2 mx-2">
                    <i class="bi bi-clipboard2-x"></i> Add Block Number
                </div>
